 ...
 * including a list of {@link OSSVersionSummary} objects describing each version,
 * information describing if this is a complete or partial listing, and the
 * original request parameters.
 *
 * @see com.aliyun.oss.OSS#listVersions(String, String)
 * @see com.aliyun.oss.OSS#listVersions(ListVersionsRequest)
 */
public class VersionListing extends GenericResult {
    ...
    private List<OSSVersionSummary> versionSummaries =
            new ArrayList<OSSVersionSummary>();
     ...
     * the associated OSS bucket. Callers should remember that listings for large
     * buckets can be truncated for performance reasons, so callers might need
     * to make additional calls to
     * {@link com.aliyun.oss.OSS#listVersions(ListVersionsRequest)} to get additional
     ...
     *         the associated OSS bucket.
     */
    public List<OSSVersionSummary> getVersionSummaries() {
        return this.versionSummaries;
    }

    /**
     * For internal use only. Sets the list of version
     * summaries describing the versions stored in the associated OSS bucket.
     *
     * @param versionSummaries
     *            The version summaries describing the versions stored in the
     *            associated OSS bucket.
     */
    public void setVersionSummaries(List<OSSVersionSummary> versionSummaries) {
     ...
     * request.
     * <p>
     * Each common prefix represents a set of keys in the OSS bucket that have
    ...
    /**
     * Gets the name of the OSS bucket containing the versions listed
     * in this {@link VersionListing}.
     *
     * @return The name of the OSS bucket containing the versions listed
     *         in this OSSVersionListing.
     */
    ...
    /**
     * For internal use only. Sets the name of the OSS
     * bucket containing the versions listed in this OSSVersionListing.
     *
     * @param bucketName
     *            The name of the OSS bucket containing the versions
     *            listed in this OSSVersionListing.
     */
     ...
     * listing.  Returns the default <code>maxKeys</code> value provided by OSS if no
     ...
     * applied by OSS if the requester didn't specify a value.
     *
     * @param maxKeys
     *            The maxKeys parameter originally used to request this version
     *            listing, or the default maxKeys value applied by OSS if
     ...
     * callers to condense OSS keys into common prefix listings. For example, if
     ...
     * whether the caller needs to make additional calls to OSS to get more
     * version summaries.
     *
     * @param isTruncated
     *            True if this version listing is <b>not complete</b> and the
     *            caller needs to make additional OSS calls to get additional
     *            version summaries.
     */
    ...
    /**
     * For internal use only. Sets the encoding type used by OSS to encode
