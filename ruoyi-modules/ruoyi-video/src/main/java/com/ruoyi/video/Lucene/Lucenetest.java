package com.ruoyi.video.Lucene;
...
public class Lucenetest {
    ...
    private static String INDEX_DIR = "D:\\log\\index";
    private static String DATA_DIR = "D:\\log\\img";
    ...
    public static boolean createIndex(String path){
        ...
        for (File file : fileList) {
            ...
            try{
                ...
                //本地文件存储
                directory = FSDirectory.open(Paths.get(INDEX_DIR).toFile());
                //内存存储
