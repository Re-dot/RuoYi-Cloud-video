...
public class UserQosInfo extends GenericResult {
     ...
     * 
     * @param totalUplaodBw
     *          The value of total upload bandwith, -1 means no config here and 0 means forbidden.
     */
     ...
     *          The value of the intranet upload bandwith, -1 means no config here and 0 means forbidden.
     */
     ...
     *          The value of extranet upload bandwith, -1 means no config here and 0 means forbidden.
     */
     ...
     *          The value of the total download bandwith, -1 means no config here and 0 means forbidden.
     */
     ...
     *          The value of total download bandwith, -1 means no config here and 0 means forbidden.
     */
     ...
     *          The value of intranet download bandwith, -1 means no config here and 0 means forbidden.
     */
     ...
     *          The value of extranet download bandwith, -1 means no config here and 0 means forbidden
     */
     ...
     * 
     * @param totalQps
     *          The value of total qps, -1 means no config here and 0 means forbidden.
     */
     ...
     * @param intranetQps
     *          The value of intranet qps, -1 means no config here and 0 means forbidden.
     */
     ...
     * 
     * @param extranetQps
     *          The value of extranet qps, -1 means no config here and 0 means forbidden.
     */
